...
export default class UpgradeMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.levelUpBtn = new PurpleButton(this, menuWidth-63, 55, 'Lvl Up', this.levelUp, menuContainer)
        this.swapShipBtn = new PurpleButton(this, this.shipImg.displayWidth/2 + 8, menuHeight-20, 'Swap', this.swapShip, menuContainer)
        this.equipmentBtn = new PurpleButton(this, menuWidth-58, menuHeight-20, 'Equipment', this.openEquipment, menuContainer, 1.1)
